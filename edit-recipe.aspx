<%@ Page Title="Edit Recipe" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="edit-recipe.aspx.cs" Inherits="Hope.edit_recipe" %>
    ...
    <main class="min-h-screen bg-gray-50 py-12 sm:px-6 lg:px-8 pt-24">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-8">
                <h1 class="text-4xl font-bold text-gray-900 mb-4">Edit Recipe</h1>
                <p class="text-lg text-gray-600">Update your recipe details below</p>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <asp:Panel ID="FormPanel" runat="server" CssClass="p-8 space-y-8">
                    ...
                    <asp:Panel ID="MediaPanel" runat="server">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-sm text-gray-500">Upload a new photo to replace the current one (optional)</p>
                            </div>
                            <!-- YouTube Video Link -->
                            <div>
                    ...
                    <div class="flex flex-col md:flex-row gap-4 pt-6">
                        ...
                        <a href="admin-recipe.aspx" class="flex-1 bg-gray-200 text-gray-700 py-3 px-6 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition duration-300 flex items-center justify-center">
