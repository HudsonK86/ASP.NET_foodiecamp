<%@ Page Title="Admin Dashboard" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="admin-profile.aspx.cs" Inherits="Hope.admin_profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="admin-sidebar bg-white shadow-lg fixed left-0 top-16 z-40">
        <div class="p-4 border-b">
            <div class="flex items-center">
                <asp:Image ID="AdminProfileImage" runat="server" 
                    ImageUrl="~/images/profiles/default-avatar.png" 
        ...
        <nav class="mt-4">
            ...
            <a href="admin-profile.aspx" class="flex items-center px-4 py-3 text-white bg-blue-600">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="flex items-center space-x-6">
                                <div class="w-32 h-32 rounded-full overflow-hidden bg-gray-100">
                                    ...
                                    <div ID="DefaultProfileImage" runat="server" class="w-full h-full flex items-center justify-center bg-gray-200">
